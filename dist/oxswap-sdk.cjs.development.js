...
var IUniswapV2Pair = _interopDefault(require('oxswap-core/build/contracts/IUniswapV2Pair.json'));
...
var FACTORY_ADDRESS = {
  1: "",
  56: "",
  1666600000: "0xC342d6CCd44A198A4f2B19645FaA687eebca600F",
...
var INIT_CODE_HASH = {
  1: "",
  56: "",
  1666600000: '0xf5c6349a3426610a576de8f5064de4fbb6eb7242dc4615964596f301ec76e1de',
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'ONSP', 'OxSwap');
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    ...
    if (((_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE) == null ? void 0 : (_PAIR_ADDRESS_CACHE$t = _PAIR_ADDRESS_CACHE[tokens[0].address]) == null ? void 0 : _PAIR_ADDRESS_CACHE$t[tokens[1].address]) === undefined) {
      ...
      PAIR_ADDRESS_CACHE = _extends({}, PAIR_ADDRESS_CACHE, (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE2 = PAIR_ADDRESS_CACHE) == null ? void 0 : _PAIR_ADDRESS_CACHE2[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = address.getCreate2Address(FACTORY_ADDRESS[id], solidity.keccak256(['bytes'], [solidity.pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), INIT_CODE_HASH[id]), _extends2)), _extends3));
    }
    ...
    if (!feeOn) {
      ...
      if (!JSBI.equal(kLastParsed, ZERO)) {
        ...
        if (JSBI.greaterThan(rootK, rootKLast)) {
          ...
          var denominator = JSBI.add(JSBI.multiply(rootK, ONE), rootKLast);
...
var Fetcher = /*#__PURE__*/function () {
  ...
  /*#__PURE__*/
  function () {
    var _fetchTokenData = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(chainId, address, symbol, name) {
      var _TOKEN_DECIMALS_CACHE2, _TOKEN_DECIMALS_CACHE3;

      var provider, parsedDecimals;
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              provider = new providers.JsonRpcProvider(RPC_URLS[chainId], {
                chainId: chainId,
                name: "any"
              });
    ...
    function fetchTokenData(_x, _x2, _x3, _x4) {
  ...
  /*#__PURE__*/
  function () {
    var _fetchPairData = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(tokenA, tokenB) {
      var provider, address, _yield$Contract$getRe, reserves0, reserves1, balances;

      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              provider = new providers.JsonRpcProvider(RPC_URLS[tokenA.chainId], {
              ...
              _context2.next = 5;
              return new contracts.Contract(address, IUniswapV2Pair.abi, provider).getReserves();
    ...
    function fetchPairData(_x5, _x6) {
